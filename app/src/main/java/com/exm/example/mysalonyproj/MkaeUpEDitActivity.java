...
public class MkaeUpEDitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mkae_up_edit);
    ...
    private void storeproductinfo() {
        ...
        loadingBar.setMessage(Integer.toString(R.string.Pleasewaitwhileweareaddingnewservice) );
    ...
    private void saveprointodatabase() {
        ...
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child("Salonat").child(mAuth.getCurrentUser().getUid());
